var pe=Object.defineProperty;var fe=(e,i,d)=>i in e?pe(e,i,{enumerable:!0,configurable:!0,writable:!0,value:d}):e[i]=d;var R=(e,i,d)=>(fe(e,typeof i!="symbol"?i+"":i,d),d);import{t as me,m as ve,l as ye,u as z,n as he,p as Y,q as W,j as P,F as ge,r as Q,v as xe,a as H,_ as G,w as L,x as J,L as _e}from"./index.3f21dce0.js";import{i as N,v as F,e as E,y as k,a0 as V,b as ee,k as oe,z as te,p as be,a7 as O,ag as ne,a9 as B,ai as Ce,M as ke,Y as Ae,a8 as X,aa as I,ad as we,ae as j,ab as Ee,E as Se}from"./vendor.0e7da6ec.js";/**
 * @license
 *
...
})`,Je=F({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(e){const{lang:i}=N(H);return{onClick:()=>{var h;const u=document.createElement("div");u.style.display="none";const y=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${Oe(e.code)}`;u.innerHTML=`<a href=${y} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(h=u.querySelector("a"))==null||h.click(),document.body.removeChild(u)},lang:i}}});function qe(e,i,d,u,x,y){const h=L,m=J;return O(),ne(m,{title:e.lang==="zh"?"\u5728 CodeSandbox \u4E2D\u6253\u5F00":"Open on CodeSandbox"},{default:B(()=>[k(h,{name:"code",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const Ke=G(Je,[["render",qe]]),Ze=F({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(e){const{lang:i}=N(H);return{onClick:()=>{var y;const u=document.createElement("div");u.style.display="none";const x=Ye(e.code);u.innerHTML=`<a href=${x} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(y=u.querySelector("a"))==null||y.click(),document.body.removeChild(u)},lang:i}}}),Xe=e=>btoa(unescape(encodeURIComponent(e))),Ye=e=>{const d={"App.vue":decodeURIComponent(e)};return`https://playground.idux.site/#${Xe(JSON.stringify(d))}`};function We(e,i,d,u,x,y){const h=L,m=J;return O(),ne(m,{title:e.lang==="zh"?"\u5728 Playground \u4E2D\u6253\u5F00":"Open on Playground"},{default:B(()=>[k(h,{name:"bug",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const Qe=G(Ze,[["render",We]]);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */class Ve{constructor(i){R(this,"_textarea");const d=this._textarea=document.createElement("textarea"),u=d.style;u.opacity="0",u.position="absolute",u.left=u.top="-999em",d.setAttribute("aria-hidden","true"),d.value=i,document.body.appendChild(d)}copy(){const i=this._textarea;let d=!1;try{if(i){const u=document.activeElement;i.select(),i.setSelectionRange(0,i.value.length),d=document.execCommand("copy"),u&&u.focus()}}catch(u){_e.error("cdk/clipboard",u)}return d}destroy(){const i=this._textarea;i&&(i.parentNode&&i.parentNode.removeChild(i),this._textarea=void 0)}}/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const T=class{static getInstance(){return T.instance||(T.instance=new T),T.instance}constructor(){}copy(i){const d=this.beginCopy(i),u=d.copy();return d.destroy(),u}beginCopy(i){return new Ve(i)}};let M=T;R(M,"instance",null);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const eo=()=>{const e=M.getInstance(),i=new Set;let d=!1,u=null;Ce(()=>{u!==null&&clearTimeout(u),i.forEach(y=>y.destroy()),i.clear(),d=!0});function x(y,h=1){return new Promise(o=>{if(h>1){let s=h;const a=e.beginCopy(y);i.add(a);const r=()=>{const t=a.copy();!t&&--s&&!d?u=setTimeout(r,1):(u=null,i.delete(a),a.destroy(),o(t))};r()}else{const s=e.copy(y);o(s)}})}return{copy:x}},oo=F({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(e){const{lang:i}=N(H),d=E(()=>`${e.packageName}-${e.componentName}-${Ae(e.demoName)}`),u=E(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${e.packageName}/${e.componentName}/demo/${e.demoName}`}.md`),x=ee(!1),y=E(()=>i.value==="zh"?x.value?"\u6536\u8D77\u4EE3\u7801":"\u663E\u793A\u4EE3\u7801":x.value?"Hide Code":"Show Code"),h=()=>{x.value=!x.value},{copy:m}=eo(),{success:o}=$e(),s=ke(()=>{m(decodeURIComponent(e.code)).then(()=>{o(i.value==="zh"?"\u590D\u5236\u6210\u529F":"copy succeeded")})},300);return{id:d,lang:i,editHref:u,expanded:x,expandedTitle:y,onExpanded:h,onCopy:s}}});const to=["id"],no={class:"global-code-box-title markdown"},so=["href"],ao={class:"global-code-box-description"},ro={class:"global-code-box-content"},io={class:"global-code-box-content-border"},co={class:"global-code-box-raw-code"},lo={class:"global-code-box-tools"},uo=["href"],po={key:0,class:"global-code-box-highlight-code"};function fo(e,i,d,u,x,y){const h=Qe,m=Ke,o=L,s=J,a=Q;return O(),X("div",{id:e.id,class:"global-code-box"},[I("div",no,[I("h3",null,[I("span",null,we(e.title),1),I("a",{class:"anchor",href:"#"+e.id},"#",8,so)])]),I("div",ao,[j(e.$slots,"description")]),I("div",ro,[I("div",io,[I("div",co,[j(e.$slots,"rawCode"),I("div",lo,[k(a,null,{default:B(()=>[k(h,{code:e.code},null,8,["code"]),k(m,{code:e.code},null,8,["code"]),k(s,{title:e.lang==="zh"?"\u5728 GitHub \u4E0A\u7F16\u8F91\u6B64\u793A\u4F8B":"Edit this demo on GitHub"},{default:B(()=>[I("a",{href:e.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[k(o,{name:"edit"})],8,uo)]),_:1},8,["title"]),k(s,{title:e.lang==="zh"?"\u590D\u5236\u4EE3\u7801":"Copy code"},{default:B(()=>[k(o,{name:"copy",onClick:e.onCopy},null,8,["onClick"])]),_:1},8,["title"]),k(s,{title:e.expandedTitle},{default:B(()=>[k(o,{name:e.expanded?"unexpand":"expand",onClick:e.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),k(Se,{name:"ix-fade-down"},{default:B(()=>[e.expanded?(O(),X("div",po,[j(e.$slots,"highlightCode")])):Ee("",!0)]),_:3})])])],8,to)}const bo=G(oo,[["render",fo]]);export{_o as I,bo as _,eo as a,xo as b,$e as u};
