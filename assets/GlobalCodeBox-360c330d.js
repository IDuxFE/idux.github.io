var be=Object.defineProperty;var _e=(e,r,c)=>r in e?be(e,r,{enumerable:!0,configurable:!0,writable:!0,value:c}):e[r]=c;var L=(e,r,c)=>(_e(e,typeof r!="symbol"?r+"":r,c),c);import{a5 as Ce,a6 as ke,a7 as Se,M as K,N as q,a8 as $e,a9 as we,Q as Ie,ɵ as ne,r as re,aa as le,m as M,k as ie,a as Q,_ as W,A as Y,ab as V,ac as Ae}from"./index-e89cd1aa.js";import{x as R,l as O,c as I,r as ee,d as ce,n as F,p as $,ac as J,B as Be,s as Ee,m as Te,aC as Pe,ag as j,aq as de,ai as T,L as De,K as Ne,Z as Me,ah as se,ak as A,an as Re,ao as Z,al as Oe,V as ze}from"./vendor-cb0c1489.js";/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Ue=()=>{const e=R(Ce,null);return e===null?ke("components/message","<IxMessageProvider> not found."):e};/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
...
})`,ao=O({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(e){const{lang:r}=R(Q);return{onClick:()=>{var _;const d=document.createElement("div");d.style.display="none";const x=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${We(e.code)}`;d.innerHTML=`<a href=${x} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(_=d.querySelector("a"))==null||_.click(),document.body.removeChild(d)},lang:r}}});function ro(e,r,c,d,S,x){const _=Y,h=V;return j(),de(h,{title:e.lang==="zh"?"在 CodeSandbox 中打开":"Open on CodeSandbox"},{default:T(()=>[$(_,{name:"code",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const lo=W(ao,[["render",ro]]),io=O({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(e){const{lang:r}=R(Q);return{onClick:()=>{var x;const d=document.createElement("div");d.style.display="none";const S=uo(e.code);d.innerHTML=`<a href=${S} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(x=d.querySelector("a"))==null||x.click(),document.body.removeChild(d)},lang:r}}}),co=e=>btoa(unescape(encodeURIComponent(e))),uo=e=>{const c={"App.vue":decodeURIComponent(e)};return`https://playground.idux.site/#${co(JSON.stringify(c))}`};function po(e,r,c,d,S,x){const _=Y,h=V;return j(),de(h,{title:e.lang==="zh"?"在 Playground 中打开":"Open on Playground"},{default:T(()=>[$(_,{name:"bug",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const fo=W(io,[["render",po]]);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const P=class P{static getInstance(){return P.instance||(P.instance=new P),P.instance}constructor(){}copy(r){const c=this.beginCopy(r),d=c.copy();return c.destroy(),d}beginCopy(r){return new mo(r)}};L(P,"instance",null);let X=P;/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const vo=()=>{const e=X.getInstance(),r=new Set;let c=!1,d=null;De(()=>{d!==null&&clearTimeout(d),r.forEach(x=>x.destroy()),r.clear(),c=!0});function S(x,_=1){return new Promise(t=>{if(_>1){let n=_;const l=e.beginCopy(x);r.add(l);const a=()=>{const s=l.copy();!s&&--n&&!c?d=setTimeout(a,1):(d=null,r.delete(l),l.destroy(),t(s))};a()}else{const n=e.copy(x);t(n)}})}return{copy:S}},ho=O({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(e){const{lang:r}=R(Q),c=I(()=>`${e.packageName}-${e.componentName}-${Ne(e.demoName)}`),d=I(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${e.packageName}/${e.componentName}/demo/${e.demoName}`}.md`),S=ee(!1),x=I(()=>r.value==="zh"?S.value?"收起代码":"显示代码":S.value?"Hide Code":"Show Code"),_=()=>{S.value=!S.value},{copy:h}=vo(),{success:t}=Ue(),n=Me(()=>{h(decodeURIComponent(e.code)).then(()=>{t(r.value==="zh"?"复制成功":"copy succeeded")})},300);return{id:c,lang:r,editHref:d,expanded:S,expandedTitle:x,onExpanded:_,onCopy:n}}});const yo=["id"],go={class:"global-code-box-title markdown"},xo=["href"],bo={class:"global-code-box-description markdown"},_o={class:"global-code-box-content"},Co={class:"global-code-box-content-border"},ko={class:"global-code-box-raw-code"},So={class:"global-code-box-tools"},$o=["href"],wo={key:0,class:"global-code-box-highlight-code"};function Io(e,r,c,d,S,x){const _=fo,h=lo,t=Y,n=V,l=ie;return j(),se("div",{id:e.id,class:"global-code-box"},[A("div",go,[A("h3",null,[A("span",null,Re(e.title),1),A("a",{class:"anchor",href:"#"+e.id},"#",8,xo)])]),A("div",bo,[Z(e.$slots,"description")]),A("div",_o,[A("div",Co,[A("div",ko,[Z(e.$slots,"rawCode"),A("div",So,[$(l,null,{default:T(()=>[$(_,{code:e.code},null,8,["code"]),$(h,{code:e.code},null,8,["code"]),$(n,{title:e.lang==="zh"?"在 GitHub 上编辑此示例":"Edit this demo on GitHub"},{default:T(()=>[A("a",{href:e.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[$(t,{name:"edit"})],8,$o)]),_:1},8,["title"]),$(n,{title:e.lang==="zh"?"复制代码":"Copy code"},{default:T(()=>[$(t,{name:"copy",onClick:e.onCopy},null,8,["onClick"])]),_:1},8,["title"]),$(n,{title:e.expandedTitle},{default:T(()=>[$(t,{name:e.expanded?"custom:collapse":"custom:expand",onClick:e.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),$(ze,{name:"ix-fade-down"},{default:T(()=>[e.expanded?(j(),se("div",wo,[Z(e.$slots,"highlightCode")])):Oe("",!0)]),_:3})])])],8,yo)}const Do=W(ho,[["render",Io]]);export{Po as I,Do as _,vo as a,To as b,Ue as u};
