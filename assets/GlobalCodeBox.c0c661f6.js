...
})`,ce=P({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(a){const{lang:l}=N(M);return{onClick:()=>{var g;const p=document.createElement("div");p.style.display="none";const _=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${ee(a.code)}`;p.innerHTML=`<a href=${_} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(p),(g=p.querySelector("a"))==null||g.click(),document.body.removeChild(p)},lang:l}}});function le(a,l,f,p,C,_){const g=E("IxIcon"),v=E("IxTooltip");return O(),G(v,{title:a.lang==="zh"?"\u5728 CodeSandbox \u4E2D\u6253\u5F00":"Open on CodeSandbox"},{default:D(()=>[A(g,{name:"code",onClick:a.onClick},null,8,["onClick"])]),_:1},8,["title"])}var de=j(ce,[["render",le]]);class pe{constructor(l){const f=this._textarea=document.createElement("textarea"),p=f.style;p.opacity="0",p.position="absolute",p.left=p.top="-999em",f.setAttribute("aria-hidden","true"),f.value=l,document.body.appendChild(f)}copy(){const l=this._textarea;let f=!1;try{if(l){const p=document.activeElement;l.select(),l.setSelectionRange(0,l.value.length),f=document.execCommand("copy"),p&&p.focus()}}catch(p){z.error("cdk/clipboard",p)}return f}destroy(){const l=this._textarea;l&&(l.parentNode&&l.parentNode.removeChild(l),this._textarea=void 0)}}const S=class{static getInstance(){return S.instance||(S.instance=new S),S.instance}constructor(){}copy(a){const l=this.beginCopy(a),f=l.copy();return l.destroy(),f}beginCopy(a){return new pe(a)}};let R=S;R.instance=null;const ue=()=>{const a=R.getInstance(),l=new Set;let f=!1,p=null;F(()=>{p!==null&&clearTimeout(p),l.forEach(_=>_.destroy()),l.clear(),f=!0});function C(_,g=1){return new Promise(o=>{if(g>1){let t=g;const c=a.beginCopy(_);l.add(c);const n=()=>{const r=c.copy();!r&&--t&&!f?p=setTimeout(n,1):(p=null,l.delete(c),c.destroy(),o(r))};n()}else{const t=a.copy(_);o(t)}})}return{copy:C}};const fe=P({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(a){const{lang:l}=N(M),f=T(()=>`${a.packageName}-${a.componentName}-demo-${a.demoName}`),p=T(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${a.packageName}/${a.componentName}/demo/${a.demoName}`}.md`),C=J(!1),_=T(()=>l.value==="zh"?C.value?"\u6536\u8D77\u4EE3\u7801":"\u663E\u793A\u4EE3\u7801":C.value?"Hide Code":"Show Code"),g=()=>{C.value=!C.value},{copy:v}=ue(),{success:o}=H(),t=X(()=>{v(decodeURIComponent(a.code)).then(()=>{o(l.value==="zh"?"\u590D\u5236\u6210\u529F":"copy succeeded")})},300);return{id:f,lang:l,editHref:p,expanded:C,expandedTitle:_,onExpanded:g,onCopy:t}}}),me=["id"],ve={class:"global-code-box-title markdown"},xe={class:"global-code-box-border"},he={class:"global-code-box"},ye={class:"global-code-box-meta markdown"},_e={class:"global-code-box-description"},ge={class:"global-code-box-actions"},Ce=["href"],be={class:"global-code-box-demo"};function we(a,l,f,p,C,_){const g=de,v=E("IxIcon"),o=E("IxTooltip");return O(),Z("div",{id:a.id,class:"global-code-box-wrapper"},[k("section",ve,[k("h3",null,Y(a.title),1)]),k("div",xe,[k("section",he,[k("section",ye,[k("div",_e,[$(a.$slots,"description")]),k("div",ge,[A(g,{code:a.code},null,8,["code"]),A(o,{title:a.lang==="zh"?"\u5728 GitHub \u4E0A\u7F16\u8F91\u6B64\u793A\u4F8B":"Edit this demo on GitHub"},{default:D(()=>[k("a",{href:a.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[A(v,{name:"edit"})],8,Ce)]),_:1},8,["title"]),A(o,{title:a.lang==="zh"?"\u590D\u5236\u4EE3\u7801":"Copy code"},{default:D(()=>[A(v,{name:"copy",onClick:a.onCopy},null,8,["onClick"])]),_:1},8,["title"]),A(o,{title:a.expandedTitle},{default:D(()=>[A(v,{name:a.expanded?"unexpand":"expand",onClick:a.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])])]),k("section",be,[$(a.$slots,"rawCode")]),k("section",{class:q(["highlight-wrapper",{"highlight-wrapper-expand":a.expanded}])},[$(a.$slots,"highlightCode")],2)])])],8,me)}var Ae=j(fe,[["render",we]]);export{Ae as _,ue as u};
