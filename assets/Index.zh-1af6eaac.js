import{I as y,a as D}from"./index-14e2dfc5.js";import{_ as S,I as $}from"./GlobalCodeBox-588cbf36.js";import{v as B,b as d,x as V,w as M,N as T,a9 as m,ab as n,y as a,aa as p,ae as b,F,a8 as r,ad as s,i as L,ah as C,ac as w,ai as h,aq as _,am as N,al as q,H as A,I as v}from"./vendor-4521613a.js";import{k as R,c as H,_ as f,a as U}from"./index-b887bcb8.js";const Q={class:"example-focus-monitor"},z={class:"example-focus-monitor"},G=B({__name:"FocusMonitor",setup(c){const e=d(),t=d(),o=d(null),k=d(null),u=R();return V(()=>{setInterval(()=>{o.value?u.blurVia(e.value):u.focusVia(e.value,"program")},3e3),M(u.monitor(e),({origin:l,event:i})=>{o.value=l,console.log(l,i)}),M(u.monitor(t,!0),({origin:l,event:i})=>{k.value=l,console.log(l,i)})}),T(()=>{u.stopMonitoring(e),u.stopMonitoring(t)}),(l,i)=>{const g=H;return r(),m(F,null,[n("div",Q,[a(g,{ref_key:"element",ref:e,ghost:""},{default:p(()=>[s("Focus Monitored Element ("+b(o.value)+")",1)]),_:1},512)]),n("div",z,[n("div",{ref_key:"subtree",ref:t},[n("p",null,"Focus Monitored Subtree ("+b(k.value)+")",1),a(g,{ghost:""},{default:p(()=>[s("Child Button 1")]),_:1}),a(g,{ghost:""},{default:p(()=>[s("Child Button 2")]),_:1})],512)])],64)}}});const P=f(G,[["__scopeId","data-v-fb0d5b68"]]),j=B({name:"FocusMonitor",components:{"raw-demo":P},setup(){const{lang:c}=L(U);return{lang:c}}}),Y=n("p",null,[n("code",null,"FocusMonitor"),s(" 可以用来监听元素焦点状态的变化。")],-1),J=n("p",null,"你可以尝试使用鼠标或者键盘来获取按钮的焦点。",-1),K=n("p",null,[n("code",null,"FocusMonitor"),s(" can be used to listen for changes in the focus state of an element.")],-1),W=n("p",null,"You can try using the mouse or keyboard to get the focus of the button.",-1),X=n("div",null,[n("pre",{class:"language-html"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
