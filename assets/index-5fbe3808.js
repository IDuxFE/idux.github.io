import{c as v,bf as L,au as R,bg as B,x as U,R as J,d as C,i as k,f as o,$ as M,aN as V,h as Q,aW as _,bh as q,as as N,at as G,a5 as H,af as O,an as W}from"./index-068e057b.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const K={prev:"left",next:"right",prev5:"double-left",next5:"double-right",page:""},le={next:1,prev:-1,prev5:-5,next5:5},j=C({props:ae,setup(e){const{props:n,slots:t,config:a,locale:l,mergedPrefixCls:u,activeIndex:i,changePageIndex:p}=k(P),s=v(()=>i.value===e.index),d=v(()=>e.disabled||n.disabled),g=v(()=>{var r;return(r=n.showTitle)!=null?r:a.showTitle}),m=v(()=>{const r=`${u.value}-item`;return{[r]:!0,[`${r}-${e.type}`]:!0,[`${r}-active`]:s.value,[`${r}-disabled`]:d.value}}),T=v(()=>{if(!g.value)return;const{type:r,index:f}=e;return r==="page"?f:l.pagination[r]}),b=()=>{if(d.value)return;const{type:r,index:f}=e;let h;r==="page"?h=f:h=i.value+le[r],p(h)},z=r=>{d.value||r.code!=="Enter"||b()};return()=>{const r=`${u.value}-item`,{index:f,type:h}=e,$=d.value;let y;e.type==="prev5"||h==="next5"?y=o("span",{class:` ${r}-jumper`},[o(M,{name:K[h]},null),o(M,{class:`${r}-ellipsis`,name:"ellipsis"},null)]):V(f)?y=o(M,{name:K[h]},null):y=Q(f);const w=t.item?t.item({index:f,type:h,active:s.value,disabled:$,original:y}):y;return o("li",{class:m.value,tabindex:$?-1:0,title:T.value,onClick:b,onKeydown:z},[o("span",{class:`${r}-content`},[w])])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const ue=C({name:"IxPagination",props:ne,setup(e,{slots:n}){const t=N("common"),{globalHashId:a,hashId:l,registerToken:u}=G("pagination");u(oe);const i=v(()=>`${t.prefixCls}-pagination`),p=N("locale"),s=N("pagination"),d=v(()=>{var c;return(c=e.showTotal)!=null?c:s.showTotal}),g=v(()=>{var c;return(c=e.simple)!=null?c:s.simple}),m=v(()=>{var c;return(c=e.size)!=null?c:s.size}),T=v(()=>{var c;return(c=e.showQuickJumper)!=null?c:s.showQuickJumper}),b=v(()=>{var c;return(c=e.showSizeChanger)!=null?c:s.showSizeChanger}),{activeIndex:z,activeSize:r,lastIndex:f,changePageIndex:h,changePageSize:$}=ee(e,s),y=X(z,f),w=Z(z,h,g);H(P,{props:e,slots:n,config:s,locale:p,mergedPrefixCls:i,mergedSize:m,activeIndex:z,activeSize:r,lastIndex:f,changePageIndex:h,changePageSize:$,jumpToIndex:w});const E=v(()=>{const c=i.value;return W({[a.value]:!!a.value,[l.value]:!!l.value,[c]:!0,[`${c}-disabled`]:e.disabled,[`${c}-simple`]:g.value,[`${c}-${m.value}`]:!0})});return()=>{const c=i.value,x=d.value?[o(ie,null,null)]:[];if(g.value){const S=z.value,A=f.value;x.push(o(j,{disabled:S===1,type:"prev"},null)),x.push(o("li",{class:`${c}-item`},[T.value?o(_,{disabled:e.disabled,size:m.value==="lg"?"md":"sm",value:S.toString(),onKeydown:w},null):S,o("span",{class:`${c}-item-slash`},[Q("/")]),o("span",null,[A])])),x.push(o(j,{disabled:S===A,type:"next"},null)),b.value&&x.push(o(F,null,null))}else y.value.forEach(S=>x.push(o(j,O({key:S.type+"-"+S.index},S),null))),b.value&&x.push(o(F,null,null)),T.value&&x.push(o(se,null,null));return o("ul",{class:E.value},[x])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
