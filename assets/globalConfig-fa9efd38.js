import{I as s}from"./index-3834b844.js";import{y as i,z as p,A as r,B as m,D as u}from"./vendor-7de7c0f1.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const n={common:{prefixCls:"ix-pro"},locale:f,form:{ajvOptions:{allErrors:!0,loopEnum:50,code:{esm:!0}},autoId:!0,autoLabelFor:!0,formatComponents:{default:{component:s}},ignoreKeywords:["type","enum"],schemaFormatter:(e,l)=>({fields:e||{},schema:l||{}})},table:{layoutTool:{changeSize:!0,resetable:!0,searchable:!1}},tree:{clearIcon:"close-circle",collapseIcon:["collapse","expand"]},textarea:{clearable:!1,clearIcon:"close-circle",resize:"none",size:"md",showCount:!1,trim:!1},search:{clearable:!0,clearIcon:"close-circle",searchIcon:"search",size:"md"}};/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const h=Object.keys(n).map(e=>[e,Symbol(e)]),b=new Map(h);function y(e,l){const a=b.get(e),t=i(a,n[e]);if(!l)return t;const o=p(r(m(t),l));return u(a,o),[o,c=>r(o,c)]}export{y as u};
