import{T as v,U as $,ac as C}from"./index-974a2c75.js";import{m as T,c as f,q as x,v as p}from"./vendor-e200cecb.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const L=(a,i)=>z(a),P=T({name:"IxDivider",props:I,setup(a,{slots:i}){const c=v("common"),{globalHashId:o,hashId:r,registerToken:m}=$("divider");m(L);const s=f(()=>`${c.prefixCls}-divider`),l=v("divider"),d=f(()=>{const{dashed:t=l.dashed,label:n,labelPlacement:S=l.labelPlacement,plain:h=l.plain,size:b=l.size,vertical:u}=a,g=!!n||!!i.default,e=s.value;return x({[o.value]:!!o.value,[r.value]:!!r.value,[`${e}`]:!0,[`${e}-${b}`]:!0,[`${e}-dashed`]:t,[`${e}-horizontal`]:!u,[`${e}-vertical`]:u,[`${e}-plain`]:g&&h,[`${e}-with-label`]:g,[`${e}-with-label-${S}`]:g})});return()=>{const t=s.value,n=C(i.default,a.label);return p("div",{class:d.value},[n&&p("span",{class:`${t}-label`},[n])])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
