import{M as b,N as z,ao as W,ar as j,m as A,A as D,b as p,e as I,c as F}from"./index-ab015422.js";import{l as T,c as u,D as X,p as w,q as d,f as E,j as O,a8 as V,y as q}from"./vendor-885c608a.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const G=(e,a,l)=>a==="default"?x(e,l):J(e,l),K=T({name:"IxCard",props:R,setup(e,{slots:a}){const l=b("common"),{globalHashId:o,hashId:n,registerToken:r}=z("card");r(G);const i=u(()=>`${l.prefixCls}-card`),c=b("card"),f=u(()=>{var t;return(t=e.hoverable)!=null?t:c.hoverable});X(B,{hoverable:f});const[s,g]=W(e,"selected",!1),v=u(()=>e.disabled),h=u(()=>e.selectable),P=()=>{if(v.value||!h.value)return;const t=!s.value;g(t),A(e.onSelectedChange,t)};return()=>{var $,y;const t=i.value,{borderless:N=c.borderless,loading:H,size:S=c.size,shadow:L=c.shadow}=e,C=(y=($=a.default)==null?void 0:$.call(a))!=null?y:[],m=C.some(k=>k.type&&k.type.name==="IxCardGrid"),M=w({[o.value]:!!o.value,[n.value]:!!n.value,[t]:!0,[`${t}-borderless`]:N,[`${t}-hoverable`]:!m&&f.value,[`${t}-loading`]:H,[`${t}-has-shadow`]:L,[`${t}-has-grid`]:m,[`${t}-${S}`]:!0,[`${t}-selectable`]:h.value,[`${t}-selected`]:h.value&&s.value,[`${t}-disabled`]:v.value});return d("div",{class:M,onClick:P},[Y(e,a,t),d(j,{size:S,header:e.header},a),Z(e,C,m,t),ae(e,a,t),Q(e,t)])}}}),Q=(e,a)=>{if(u(()=>{var o;return(o=e.selectable)!=null?o:!1}).value)return d("div",{class:`${a}-mark-wrap`},[d("div",{class:`${a}-mark`},null),d(D,{name:"check-filled",class:`${a}-mark-icon`,color:"white"},null)])},Y=(e,a,l)=>{let o;if(a.cover)o=a.cover();else if(e.cover){const{cover:n}=e,r=E(n)?{src:n}:n;o=d("img",r,null)}return o?d("div",{class:`${l}-cover`},[o]):void 0},Z=(e,a,l,o)=>{let n;return e.loading?n=ee(o):a.length&&(n=l?d(p,null,{default:()=>[a]}):a),n?d("div",{class:`${o}-body`},[n]):void 0},_=[[22],[8,15],[6,18],[13,9],[4,3,16],[8,6,8]],ee=e=>{const a=_.map(l=>{const o=l.map(n=>d(I,{span:n,class:`${e}-loading-col`},{default:()=>[d("div",{class:`${e}-loading-block`},null)]}));return d(p,null,{default:()=>[o]})});return d("div",{class:`${e}-loading`},[a])},ae=(e,a,l)=>{if(!a.footer&&!e.footer)return;let o;return a.footer?o=a.footer():o=e.footer.map(n=>{let r;if(O(n))r=n;else{const{text:i,...c}=n;r=d(F,V({class:`${l}-footer-button`,waveless:!0},c),{default:()=>[i]})}return r?d("li",null,[r]):null}),d("ul",{class:`${l}-footer`},[o])},oe=T({name:"IxCardGrid",props:U,setup(e,{slots:a}){const l=b("common"),{globalHashId:o,hashId:n,registerToken:r}=z("card");r(G);const i=u(()=>`${l.prefixCls}-card-grid`),{hoverable:c}=q(B),f=u(()=>{var g;const s=i.value;return w({[o.value]:!!o.value,[n.value]:!!n.value,[s]:!0,[`${s}-hoverable`]:(g=e.hoverable)!=null?g:c.value})});return()=>d(I,{class:f.value},{default:()=>{var s;return[(s=a.default)==null?void 0:s.call(a)]}})}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
