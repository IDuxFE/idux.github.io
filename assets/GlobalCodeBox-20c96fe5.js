var _e=Object.defineProperty;var Ce=(e,r,i)=>r in e?_e(e,r,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[r]=i;var Z=(e,r,i)=>(Ce(e,typeof r!="symbol"?r+"":r,i),i);import{$ as ke,a0 as Se,a1 as $e,M as J,N as K,a2 as we,a3 as Ie,a4 as Ae,a5 as Be,ɵ as se,r as le,a6 as ie,m as M,k as ce,a as Y,_ as Q,A as V,a7 as ee,a8 as Te}from"./index-cd46e9ff.js";import{y as R,l as O,c as I,r as oe,d as de,p as j,q as $,a8 as X,D as Ee,s as Pe,m as De,ae as Ne,ah as H,ar as ue,aj as E,M as Me,L as Re,ad as Oe,ai as ae,al as A,ao as ze,ap as q,am as Ue,P as Fe}from"./vendor-7ed7823e.js";/**
 * @license
 *
...
})`,lo=O({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(e){const{lang:r}=R(Y);return{onClick:()=>{var _;const u=document.createElement("div");u.style.display="none";const x=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${Ve(e.code)}`;u.innerHTML=`<a href=${x} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(_=u.querySelector("a"))==null||_.click(),document.body.removeChild(u)},lang:r}}});function io(e,r,i,u,S,x){const _=V,h=ee;return H(),ue(h,{title:e.lang==="zh"?"在 CodeSandbox 中打开":"Open on CodeSandbox"},{default:E(()=>[$(_,{name:"code",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const co=Q(lo,[["render",io]]),uo=O({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(e){const{lang:r}=R(Y);return{onClick:()=>{var x;const u=document.createElement("div");u.style.display="none";const S=fo(e.code);u.innerHTML=`<a href=${S} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(x=u.querySelector("a"))==null||x.click(),document.body.removeChild(u)},lang:r}}}),po=e=>btoa(unescape(encodeURIComponent(e))),fo=e=>{const i={"App.vue":decodeURIComponent(e)};return`https://playground.idux.site/#${po(JSON.stringify(i))}`};function mo(e,r,i,u,S,x){const _=V,h=ee;return H(),ue(h,{title:e.lang==="zh"?"在 Playground 中打开":"Open on Playground"},{default:E(()=>[$(_,{name:"bug",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const vo=Q(uo,[["render",mo]]);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const go=()=>{const e=W.getInstance(),r=new Set;let i=!1,u=null;Me(()=>{u!==null&&clearTimeout(u),r.forEach(x=>x.destroy()),r.clear(),i=!0});function S(x,_=1){return new Promise(t=>{if(_>1){let n=_;const l=e.beginCopy(x);r.add(l);const a=()=>{const s=l.copy();!s&&--n&&!i?u=setTimeout(a,1):(u=null,r.delete(l),l.destroy(),t(s))};a()}else{const n=e.copy(x);t(n)}})}return{copy:S}},yo=O({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(e){const{lang:r}=R(Y),i=I(()=>`${e.packageName}-${e.componentName}-${Re(e.demoName)}`),u=I(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${e.packageName}/${e.componentName}/demo/${e.demoName}`}.md`),S=oe(!1),x=I(()=>r.value==="zh"?S.value?"收起代码":"显示代码":S.value?"Hide Code":"Show Code"),_=()=>{S.value=!S.value},{copy:h}=go(),{success:t}=je(),n=Oe(()=>{h(decodeURIComponent(e.code)).then(()=>{t(r.value==="zh"?"复制成功":"copy succeeded")})},300);return{id:i,lang:r,editHref:u,expanded:S,expandedTitle:x,onExpanded:_,onCopy:n}}});const xo=["id"],bo={class:"global-code-box-title markdown"},_o=["href"],Co={class:"global-code-box-description markdown"},ko={class:"global-code-box-content"},So={class:"global-code-box-content-border"},$o={class:"global-code-box-raw-code"},wo={class:"global-code-box-tools"},Io=["href"],Ao={key:0,class:"global-code-box-highlight-code"};function Bo(e,r,i,u,S,x){const _=vo,h=co,t=V,n=ee,l=ce;return H(),ae("div",{id:e.id,class:"global-code-box"},[A("div",bo,[A("h3",null,[A("span",null,ze(e.title),1),A("a",{class:"anchor",href:"#"+e.id},"#",8,_o)])]),A("div",Co,[q(e.$slots,"description")]),A("div",ko,[A("div",So,[A("div",$o,[q(e.$slots,"rawCode"),A("div",wo,[$(l,null,{default:E(()=>[$(_,{code:e.code},null,8,["code"]),$(h,{code:e.code},null,8,["code"]),$(n,{title:e.lang==="zh"?"在 GitHub 上编辑此示例":"Edit this demo on GitHub"},{default:E(()=>[A("a",{href:e.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[$(t,{name:"edit"})],8,Io)]),_:1},8,["title"]),$(n,{title:e.lang==="zh"?"复制代码":"Copy code"},{default:E(()=>[$(t,{name:"copy",onClick:e.onCopy},null,8,["onClick"])]),_:1},8,["title"]),$(n,{title:e.expandedTitle},{default:E(()=>[$(t,{name:e.expanded?"custom:collapse":"custom:expand",onClick:e.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),$(Fe,{name:"ix-fade-down"},{default:E(()=>[e.expanded?(H(),ae("div",Ao,[q(e.$slots,"highlightCode")])):Ue("",!0)]),_:3})])])],8,xo)}const Mo=Q(yo,[["render",Bo]]);export{No as I,Mo as _,go as a,Do as b,je as u};
