...
`),s("span",{class:"token keyword"},"export"),n(),s("span",{class:"token keyword"},"default"),n(),s("span",{class:"token function"},"defineConfig"),s("span",{class:"token punctuation"},"("),s("span",{class:"token punctuation"},"{"),n(`
  ...
  `),s("span",{class:"token punctuation"},"}"),s("span",{class:"token punctuation"},","),n(`
`),s("span",{class:"token punctuation"},"}"),s("span",{class:"token punctuation"},")"),s("span",{class:"token punctuation"},";"),n(`
`)])]),s("h2",{id:"动态切换主题"},[s("span",null,"动态切换主题"),s("a",{onclick:"window.location.hash = '动态切换主题'",class:"anchor"},"#")]),s("p",null,"TODO: 待补充")],-1);function f(h,g){const t=c,e=l;return i(),u("article",k,[a(e,{class:"site-anchor",affix:"",offset:16},{default:o(()=>[a(t,{href:"#官方主题",title:"官方主题"},{default:o(()=>[a(t,{href:"#方式一: 使用 CSS",title:"方式一: 使用 CSS"}),a(t,{href:"#方式二：使用 Less",title:"方式二：使用 Less"})]),_:1}),a(t,{href:"#自定义主题",title:"自定义主题"},{default:o(()=>[a(t,{href:"#方式一：在 Less 文件中覆盖主题变量",title:"方式一：在 Less 文件中覆盖主题变量"}),a(t,{href:"#方式二：构建工具中覆盖主题变量",title:"方式二：构建工具中覆盖主题变量"})]),_:1}),a(t,{href:"#动态切换主题",title:"动态切换主题"})]),_:1}),d,m])}const b=p(r,[["render",f]]);export{b as default};
