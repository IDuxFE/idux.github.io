import{m as N,z as $,c as v,q as F,v as C,r as R,E as j,t as G,w as L,p as q,y as D}from"./vendor-489a52b6.js";import{an as P,N as H,m as M,L as U}from"./index-b2ce1350.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const _=N({name:"CdkResizableHandle",props:Q,setup(n,{slots:e}){const{handleResizeStart:m}=$(Y),p=a=>m(n.placement,a),s=v(()=>{const a="cdk-resizable-handle";return F({[a]:!0,[`${a}-${n.placement}`]:!0})});return()=>{var a;return C("div",{class:s.value,onPointerdown:p},[(a=e.default)==null?void 0:a.call(e)])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
