...
`)])])],-1)])),_:1},8,["title"])}const Y=f(j,[["render",J]]),K={},W={class:"markdown site-doc-api"};function X(u,o){const e=B,a=y;return r(),m("section",W,[t(a,{class:"site-anchor",affix:"",offset:16},{default:i(()=>[t(e,{href:"#FocusMonitor",title:"FocusMonitor"},{default:i(()=>[t(e,{href:"#useFocusMonitor",title:"useFocusMonitor"}),t(e,{href:"#useSharedFocusMonitor",title:"useSharedFocusMonitor"})]),_:1}),t(e,{href:"#FAQ",title:"FAQ"},{default:i(()=>[t(e,{href:"#更多的使用细节和文档？",title:"更多的使用细节和文档？"})]),_:1})]),_:1}),o[0]||(o[0]=n("h3",{id:"FocusMonitor"},[n("span",null,"FocusMonitor"),n("a",{onclick:"window.location.hash = 'FocusMonitor'",class:"anchor"},"#")],-1)),o[1]||(o[1]=v(`<p>监视鼠标和键盘事件以确定焦点事件的原因。</p><pre class="language-ts"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">FocusMonitor</span> <span class="token punctuation">{</span>
