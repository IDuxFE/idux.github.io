var fe=Object.defineProperty;var me=(e,i,u)=>i in e?fe(e,i,{enumerable:!0,configurable:!0,writable:!0,value:u}):e[i]=u;var L=(e,i,u)=>(me(e,typeof i!="symbol"?i+"":i,u),u);import{a4 as ve,a5 as ye,a6 as ge,L as J,a7 as he,a8 as xe,O as be,ɵ as V,r as oe,a9 as te,m as T,k as ne,a as Z,_ as K,A as q,aa as X,ab as _e}from"./index-42dbc838.js";import{l as O,x as z,c as $,r as W,z as w,a3 as se,d as Ce,A as ae,q as ke,aa as U,aj as re,ac as D,a8 as Se,N as we,_ as Ae,ab as ee,ad as I,ag as $e,ah as H,ae as Ie,J as Be}from"./vendor-95c13cf7.js";/**
 * @license
 *
...
})`,Xe=z({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(e){const{lang:i}=O(Z);return{onClick:()=>{var h;const d=document.createElement("div");d.style.display="none";const g=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${je(e.code)}`;d.innerHTML=`<a href=${g} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(h=d.querySelector("a"))==null||h.click(),document.body.removeChild(d)},lang:i}}});function We(e,i,u,d,_,g){const h=q,v=X;return U(),re(v,{title:e.lang==="zh"?"在 CodeSandbox 中打开":"Open on CodeSandbox"},{default:D(()=>[w(h,{name:"code",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const Ye=K(Xe,[["render",We]]),Qe=z({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(e){const{lang:i}=O(Z);return{onClick:()=>{var g;const d=document.createElement("div");d.style.display="none";const _=eo(e.code);d.innerHTML=`<a href=${_} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(g=d.querySelector("a"))==null||g.click(),document.body.removeChild(d)},lang:i}}}),Ve=e=>btoa(unescape(encodeURIComponent(e))),eo=e=>{const u={"App.vue":decodeURIComponent(e)};return`https://playground.idux.site/#${Ve(JSON.stringify(u))}`};function oo(e,i,u,d,_,g){const h=q,v=X;return U(),re(v,{title:e.lang==="zh"?"在 Playground 中打开":"Open on Playground"},{default:D(()=>[w(h,{name:"bug",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const to=K(Qe,[["render",oo]]);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
