var fe=Object.defineProperty;var me=(e,i,u)=>i in e?fe(e,i,{enumerable:!0,configurable:!0,writable:!0,value:u}):e[i]=u;var L=(e,i,u)=>(me(e,typeof i!="symbol"?i+"":i,u),u);import{a4 as ve,a5 as ye,a6 as ge,L as Z,a7 as he,O as xe,ɵ as V,a8 as be,r as oe,a9 as te,m as T,j as ne,a as K,_ as q,A as X,aa as W,ab as _e}from"./index-c8a1b625.js";import{i as O,v as z,f as A,b as Y,y as w,a2 as se,k as Ce,z as ae,p as ke,a8 as U,ah as re,aa as D,aj as Se,M as we,Z as $e,a9 as ee,ab as I,ae as Ae,af as H,ac as Ie,J as Be}from"./vendor-3e7796bf.js";/**
 * @license
 *
...
})`,Xe=z({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(e){const{lang:i}=O(K);return{onClick:()=>{var h;const d=document.createElement("div");d.style.display="none";const g=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${je(e.code)}`;d.innerHTML=`<a href=${g} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(h=d.querySelector("a"))==null||h.click(),document.body.removeChild(d)},lang:i}}});function We(e,i,u,d,_,g){const h=X,v=W;return U(),re(v,{title:e.lang==="zh"?"在 CodeSandbox 中打开":"Open on CodeSandbox"},{default:D(()=>[w(h,{name:"code",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const Ye=q(Xe,[["render",We]]),Qe=z({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(e){const{lang:i}=O(K);return{onClick:()=>{var g;const d=document.createElement("div");d.style.display="none";const _=eo(e.code);d.innerHTML=`<a href=${_} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(d),(g=d.querySelector("a"))==null||g.click(),document.body.removeChild(d)},lang:i}}}),Ve=e=>btoa(unescape(encodeURIComponent(e))),eo=e=>{const u={"App.vue":decodeURIComponent(e)};return`https://playground.idux.site/#${Ve(JSON.stringify(u))}`};function oo(e,i,u,d,_,g){const h=X,v=W;return U(),re(v,{title:e.lang==="zh"?"在 Playground 中打开":"Open on Playground"},{default:D(()=>[w(h,{name:"bug",onClick:e.onClick},null,8,["onClick"])]),_:1},8,["title"])}const to=q(Qe,[["render",oo]]);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */class no{constructor(i){L(this,"_textarea");const u=this._textarea=document.createElement("textarea"),d=u.style;d.opacity="0",d.position="absolute",d.left=d.top="-999em",u.setAttribute("aria-hidden","true"),u.value=i,document.body.appendChild(u)}copy(){const i=this._textarea;let u=!1;try{if(i){const d=document.activeElement;i.select(),i.setSelectionRange(0,i.value.length),u=document.execCommand("copy"),d&&d.focus()}}catch(d){_e.error("cdk/clipboard",d)}return u}destroy(){const i=this._textarea;i&&(i.parentNode&&i.parentNode.removeChild(i),this._textarea=void 0)}}/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const M=class{static getInstance(){return M.instance||(M.instance=new M),M.instance}constructor(){}copy(i){const u=this.beginCopy(i),d=u.copy();return u.destroy(),d}beginCopy(i){return new no(i)}};let F=M;L(F,"instance",null);/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const so=()=>{const e=F.getInstance(),i=new Set;let u=!1,d=null;Se(()=>{d!==null&&clearTimeout(d),i.forEach(g=>g.destroy()),i.clear(),u=!0});function _(g,h=1){return new Promise(o=>{if(h>1){let n=h;const r=e.beginCopy(g);i.add(r);const a=()=>{const s=r.copy();!s&&--n&&!u?d=setTimeout(a,1):(d=null,i.delete(r),r.destroy(),o(s))};a()}else{const n=e.copy(g);o(n)}})}return{copy:_}},ao=z({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(e){const{lang:i}=O(K),u=A(()=>`${e.packageName}-${e.componentName}-${$e(e.demoName)}`),d=A(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${e.packageName}/${e.componentName}/demo/${e.demoName}`}.md`),_=Y(!1),g=A(()=>i.value==="zh"?_.value?"收起代码":"显示代码":_.value?"Hide Code":"Show Code"),h=()=>{_.value=!_.value},{copy:v}=so(),{success:o}=Ee(),n=we(()=>{v(decodeURIComponent(e.code)).then(()=>{o(i.value==="zh"?"复制成功":"copy succeeded")})},300);return{id:u,lang:i,editHref:d,expanded:_,expandedTitle:g,onExpanded:h,onCopy:n}}});const ro=["id"],io={class:"global-code-box-title markdown"},lo=["href"],co={class:"global-code-box-description markdown"},uo={class:"global-code-box-content"},po={class:"global-code-box-content-border"},fo={class:"global-code-box-raw-code"},mo={class:"global-code-box-tools"},vo=["href"],yo={key:0,class:"global-code-box-highlight-code"};function go(e,i,u,d,_,g){const h=to,v=Ye,o=X,n=W,r=ne;return U(),ee("div",{id:e.id,class:"global-code-box"},[I("div",io,[I("h3",null,[I("span",null,Ae(e.title),1),I("a",{class:"anchor",href:"#"+e.id},"#",8,lo)])]),I("div",co,[H(e.$slots,"description")]),I("div",uo,[I("div",po,[I("div",fo,[H(e.$slots,"rawCode"),I("div",mo,[w(r,null,{default:D(()=>[w(h,{code:e.code},null,8,["code"]),w(v,{code:e.code},null,8,["code"]),w(n,{title:e.lang==="zh"?"在 GitHub 上编辑此示例":"Edit this demo on GitHub"},{default:D(()=>[I("a",{href:e.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[w(o,{name:"edit"})],8,vo)]),_:1},8,["title"]),w(n,{title:e.lang==="zh"?"复制代码":"Copy code"},{default:D(()=>[w(o,{name:"copy",onClick:e.onCopy},null,8,["onClick"])]),_:1},8,["title"]),w(n,{title:e.expandedTitle},{default:D(()=>[w(o,{name:e.expanded?"unexpand":"expand",onClick:e.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),w(Be,{name:"ix-fade-down"},{default:D(()=>[e.expanded?(U(),ee("div",yo,[H(e.$slots,"highlightCode")])):Ie("",!0)]),_:3})])])],8,ro)}const ko=q(ao,[["render",go]]);export{Co as I,ko as _,so as a,_o as b,Ee as u};
