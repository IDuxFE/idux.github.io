import{l as A,x as $,c as v,p as F,n as C,r as R,B as j,t as G,w as D,Z as L,v as U}from"./vendor-4aa48d2c.js";import{am as P,o as H,m as M,D as Z}from"./index-a1eb659d.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const ae=A({name:"CdkResizeObserver",props:ne,setup(n,{slots:e}){const m=R(),p=z=>M(n.onResize,z);let s;const a=()=>{s&&(s(),s=void 0)};return D([()=>n.disabled,()=>n.options],([z,f])=>{a(),z||(s=Z(m,p,f))},{immediate:!0,flush:"post"}),L(a),()=>{const z=n.is;return U(z,{ref:m,class:"cdk-resize-observer"},e)}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const re=te,oe=_,ce=ae;export{re as C,oe as a,ce as b,Q as u};
