import{bg as h,Q as S,M as P,N as B,A as D,O as k}from"./index-15e00ad6.js";import{l as y,y as z,c as a,p as $,q as o,h as M,D as E,au as _}from"./vendor-f86ff22e.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const V=(e,t)=>b(e),j=y({name:"IxTimeline",props:K,setup(e,{slots:t}){const l=P("common"),{globalHashId:r,hashId:i,registerToken:v}=B("timeline");v(V);const c=a(()=>`${l.prefixCls}-timeline`),d=a(()=>e.pending!==!1||h(t,"pending")),m=a(()=>{const{placement:g,reverse:f,both:p}=e,n=c.value;return $({[r.value]:!!r.value,[i.value]:!!i.value,[`${n}`]:!0,[`${n}-${g}`]:!0,[`${n}-reverse`]:f,[`${n}-not-both`]:!p,[`${n}-pending`]:d.value})});return E(T,{props:e,mergedPrefixCls:c}),()=>{const g=G(t,e,d,c);return o("ul",{class:m.value},[g.value])}}});function A(e){return k(e,{key:x}).map((t,l)=>(t.index=l,t))}function G(e,t,l,r){return a(()=>{var f,p;const{pending:i,pendingDot:v,reverse:c}=t,d=((f=e==null?void 0:e.default)==null?void 0:f.call(e))||[];let m=null;if(l.value){const n=((p=e==null?void 0:e.pendingDot)==null?void 0:p.call(e))||v||o(D,{name:"loading"},null);m=o(N,{class:`${r.value}-item-pending`},{default:()=>[S(e.pending,_(i)?"":i)],dot:()=>n})}const g=c?[m,...d.reverse()]:[...d,m];return A(g.filter(Boolean))})}/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const U=j,X=N;export{X as I,U as a};
