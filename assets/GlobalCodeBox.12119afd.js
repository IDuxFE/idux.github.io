...
})`,le=M({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(t){const{lang:h}=S(P);return{onClick:()=>{var x;const u=document.createElement("div");u.style.display="none";const C=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${oe(t.code)}`;u.innerHTML=`<a href=${C} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(x=u.querySelector("a"))==null||x.click(),document.body.removeChild(u)},lang:h}}});function de(t,h,v,x,u,y){const C=A("IxIcon"),f=A("IxTooltip");return U(),N(f,{title:t.lang==="zh"?"\u5728 CodeSandbox \u4E2D\u6253\u5F00":"Open on CodeSandbox"},{default:D(()=>[I(C,{name:"code",onClick:t.onClick},null,8,["onClick"])]),_:1},8,["title"])}const ue=O(le,[["render",de]]),pe=M({name:"GlobalPlayground",props:{code:{type:String,default:""}},setup(t){const{lang:h}=S(P);return{onClick:()=>{var x;const u=document.createElement("div");u.style.display="none";const y=me(t.code);u.innerHTML=`<a href=${y} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(u),(x=u.querySelector("a"))==null||x.click(),document.body.removeChild(u)},lang:h}}}),fe=t=>btoa(unescape(encodeURIComponent(t))),me=t=>{const v={"App.vue":decodeURIComponent(t)};return`https://playground.idux.site/#${fe(JSON.stringify(v))}`};function ve(t,h,v,x,u,y){const C=A("IxIcon"),f=A("IxTooltip");return U(),N(f,{title:t.lang==="zh"?"\u5728 Playground \u4E2D\u6253\u5F00":"Open on Playground"},{default:D(()=>[I(C,{name:"bug",onClick:t.onClick},null,8,["onClick"])]),_:1},8,["title"])}const xe=O(pe,[["render",ve]]),he=M({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(t){const{lang:h}=S(P),v=B(()=>`${t.packageName}-${t.componentName}-demo-${t.demoName}`),x=B(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${t.packageName}/${t.componentName}/demo/${t.demoName}`}.md`),u=L(!1),y=B(()=>h.value==="zh"?u.value?"\u6536\u8D77\u4EE3\u7801":"\u663E\u793A\u4EE3\u7801":u.value?"Hide Code":"Show Code"),C=()=>{u.value=!u.value},{copy:f}=Y(),{success:o}=K(),n=J(()=>{f(decodeURIComponent(t.code)).then(()=>{o(h.value==="zh"?"\u590D\u5236\u6210\u529F":"copy succeeded")})},300);return{id:v,lang:h,editHref:x,expanded:u,expandedTitle:y,onExpanded:C,onCopy:n}}});const ge=["id"],_e={class:"global-code-box-title markdown"},ye={class:"global-code-box-border"},Ce={class:"global-code-box"},be={class:"global-code-box-meta markdown"},we={class:"global-code-box-description"},Ie={class:"global-code-box-actions"},ke=["href"],Ee={class:"global-code-box-demo"};function Ae(t,h,v,x,u,y){const C=xe,f=ue,o=A("IxIcon"),n=A("IxTooltip"),a=A("IxSpace");return U(),Z("div",{id:t.id,class:"global-code-box-wrapper"},[k("section",_e,[k("h3",null,q(t.title),1)]),k("div",ye,[k("section",Ce,[k("section",be,[k("div",we,[T(t.$slots,"description")]),k("div",Ie,[I(a,null,{default:D(()=>[I(C,{code:t.code},null,8,["code"]),I(f,{code:t.code},null,8,["code"]),I(n,{title:t.lang==="zh"?"\u5728 GitHub \u4E0A\u7F16\u8F91\u6B64\u793A\u4F8B":"Edit this demo on GitHub"},{default:D(()=>[k("a",{href:t.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[I(o,{name:"edit"})],8,ke)]),_:1},8,["title"]),I(n,{title:t.lang==="zh"?"\u590D\u5236\u4EE3\u7801":"Copy code"},{default:D(()=>[I(o,{name:"copy",onClick:t.onCopy},null,8,["onClick"])]),_:1},8,["title"]),I(n,{title:t.expandedTitle},{default:D(()=>[I(o,{name:t.expanded?"unexpand":"expand",onClick:t.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),k("section",Ee,[T(t.$slots,"rawCode")]),k("section",{class:X(["highlight-wrapper",{"highlight-wrapper-expand":t.expanded}])},[T(t.$slots,"highlightCode")],2)])])],8,ge)}const Se=O(he,[["render",Ae]]);export{Se as _,Y as a,K as u};
