import{x as A,l as j,c as v,z as F,A as C,r as R,q as $,t as G,w as D,Q as L,B as q}from"./vendor-63a43443.js";import{aj as P,o as H,m as M,D as Q}from"./index-9308d97a.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const ae=A({name:"CdkResizeObserver",props:ne,setup(n,{slots:e}){const m=R(),p=z=>M(n.onResize,z);let s;const a=()=>{s&&(s(),s=void 0)};return D([()=>n.disabled,()=>n.options],([z,f])=>{a(),z||(s=Q(m,p,f))},{immediate:!0,flush:"post"}),L(a),()=>{const z=n.is;return q(z,{ref:m,class:"cdk-resize-observer"},e)}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
