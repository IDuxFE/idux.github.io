import{x as z,C as R,y as F,i as $,z as G,d as M,a as P,_ as j,r as D,o as N,j as H,w as k,f as A,c as B,m as L,A as J,b as Z,e as E,t as X,B as T,D as q}from"./index.830f2220.js";/**
 * @license
 *
...
})`,le=M({name:"GlobalCodeSandbox",props:{code:{type:String,default:""}},setup(c){const{lang:_}=$(P);return{onClick:()=>{var y;const x=document.createElement("div");x.style.display="none";const g=`https://codesandbox.io/api/v1/sandboxes/define?parameters=${oe(c.code)}`;x.innerHTML=`<a href=${g} target="_blank" rel="noopener noreferrer"></a>`,document.body.appendChild(x),(y=x.querySelector("a"))==null||y.click(),document.body.removeChild(x)},lang:_}}});function ue(c,_,h,x,C,g){const y=D("IxIcon"),p=D("IxTooltip");return N(),H(p,{title:c.lang==="zh"?"\u5728 CodeSandbox \u4E2D\u6253\u5F00":"Open on CodeSandbox"},{default:k(()=>[A(y,{name:"code",onClick:c.onClick},null,8,["onClick"])]),_:1},8,["title"])}const de=j(le,[["render",ue]]),pe=M({name:"GlobalCodeBox",props:{title:{type:String,default:""},packageName:{type:String,default:""},componentName:{type:String,default:""},demoName:{type:String,default:""},copied:{type:Boolean,default:!1},code:{type:String,default:""}},setup(c){const{lang:_}=$(P),h=B(()=>`${c.packageName}-${c.componentName}-demo-${c.demoName}`),x=B(()=>`https://github.com/IDuxFE/idux/edit/main/packages/${`${c.packageName}/${c.componentName}/demo/${c.demoName}`}.md`),C=L(!1),g=B(()=>_.value==="zh"?C.value?"\u6536\u8D77\u4EE3\u7801":"\u663E\u793A\u4EE3\u7801":C.value?"Hide Code":"Show Code"),y=()=>{C.value=!C.value},{copy:p}=Y(),{success:o}=K(),n=J(()=>{p(decodeURIComponent(c.code)).then(()=>{o(_.value==="zh"?"\u590D\u5236\u6210\u529F":"copy succeeded")})},300);return{id:h,lang:_,editHref:x,expanded:C,expandedTitle:g,onExpanded:y,onCopy:n}}});const fe=["id"],me={class:"global-code-box-title markdown"},ve={class:"global-code-box-border"},xe={class:"global-code-box"},he={class:"global-code-box-meta markdown"},ge={class:"global-code-box-description"},_e={class:"global-code-box-actions"},ye=["href"],Ce={class:"global-code-box-demo"};function we(c,_,h,x,C,g){const y=de,p=D("IxIcon"),o=D("IxTooltip"),n=D("IxSpace");return N(),Z("div",{id:c.id,class:"global-code-box-wrapper"},[E("section",me,[E("h3",null,X(c.title),1)]),E("div",ve,[E("section",xe,[E("section",he,[E("div",ge,[T(c.$slots,"description")]),E("div",_e,[A(n,null,{default:k(()=>[A(y,{code:c.code},null,8,["code"]),A(o,{title:c.lang==="zh"?"\u5728 GitHub \u4E0A\u7F16\u8F91\u6B64\u793A\u4F8B":"Edit this demo on GitHub"},{default:k(()=>[E("a",{href:c.editHref,class:"global-code-box-edit",target:"_blank",rel:"noopener noreferrer"},[A(p,{name:"edit"})],8,ye)]),_:1},8,["title"]),A(o,{title:c.lang==="zh"?"\u590D\u5236\u4EE3\u7801":"Copy code"},{default:k(()=>[A(p,{name:"copy",onClick:c.onCopy},null,8,["onClick"])]),_:1},8,["title"]),A(o,{title:c.expandedTitle},{default:k(()=>[A(p,{name:c.expanded?"unexpand":"expand",onClick:c.onExpanded},null,8,["name","onClick"])]),_:1},8,["title"])]),_:1})])]),E("section",Ce,[T(c.$slots,"rawCode")]),E("section",{class:q(["highlight-wrapper",{"highlight-wrapper-expand":c.expanded}])},[T(c.$slots,"highlightCode")],2)])])],8,fe)}const Ee=j(pe,[["render",we]]);export{Ee as _,Y as a,K as u};
