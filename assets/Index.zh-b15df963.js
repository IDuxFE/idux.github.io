import{I as D,a as y}from"./index-4ea7700f.js";import{_ as S,I as $}from"./GlobalCodeBox-36b6c03c.js";import{m as C,r as d,n as V,w as M,p as T,ay as r,az as m,aC as n,v as a,aA as l,aE as s,aF as B,F,z as L,aJ as h,aI as b,aD as w,aP as _,aO as N,aB as q,a8 as A,a9 as v}from"./vendor-95ed6e76.js";import{u as R,c as z,_ as f,a as H}from"./index-57842767.js";import"./__commonjsHelpers__-725317a4.js";const U={class:"example-focus-monitor"},Q={class:"example-focus-monitor"},P=C({__name:"FocusMonitor",setup(p){const e=d(),t=d(),o=d(null),k=d(null),u=R();return V(()=>{setInterval(()=>{o.value?u.blurVia(e.value):u.focusVia(e.value,"program")},3e3),M(u.monitor(e),({origin:c,event:i})=>{o.value=c,console.log(c,i)}),M(u.monitor(t,!0),({origin:c,event:i})=>{k.value=c,console.log(c,i)})}),T(()=>{u.stopMonitoring(e),u.stopMonitoring(t)}),(c,i)=>{const g=z;return r(),m(F,null,[n("div",U,[a(g,{ref_key:"element",ref:e,ghost:""},{default:l(()=>[s("Focus Monitored Element ("+B(o.value)+")",1)]),_:1},512)]),n("div",Q,[n("div",{ref_key:"subtree",ref:t},[n("p",null,"Focus Monitored Subtree ("+B(k.value)+")",1),a(g,{ghost:""},{default:l(()=>[s("Child Button 1")]),_:1}),a(g,{ghost:""},{default:l(()=>[s("Child Button 2")]),_:1})],512)])],64)}}});const G=f(P,[["__scopeId","data-v-0a69cab8"]]),j=C({name:"FocusMonitor",components:{"raw-demo":G},setup(){const{lang:p}=L(H);return{lang:p}}}),J=n("p",null,[n("code",null,"FocusMonitor"),s(" 可以用来监听元素焦点状态的变化。")],-1),Y=n("p",null,"你可以尝试使用鼠标或者键盘来获取按钮的焦点。",-1),K=n("p",null,[n("code",null,"FocusMonitor"),s(" can be used to listen for changes in the focus state of an element.")],-1),W=n("p",null,"You can try using the mouse or keyboard to get the focus of the button.",-1),X=n("div",null,[n("pre",{class:"language-html"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
