import{d as A,i as j,c as v,an as _,f as C,q as R,b3 as P,a5 as $,aj as H,R as M,a_ as G,x as L,ah as q,y as D,P as U}from"./index-200961bb.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Y=A({name:"CdkResizableHandle",props:Q,setup(n,{slots:e}){const{handleResizeStart:m}=j(F),p=a=>m(n.placement,a),s=v(()=>{const a="cdk-resizable-handle";return _({[a]:!0,[`${a}-${n.placement}`]:!0})});return()=>{var a;return C("div",{class:s.value,onPointerdown:p},[(a=e.default)==null?void 0:a.call(e)])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const ae=A({name:"CdkResizeObserver",props:ne,setup(n,{slots:e}){const m=R(),p=z=>M(n.onResize,z);let s;const a=()=>{s&&(s(),s=void 0)};return L([()=>n.disabled,()=>n.options],([z,f])=>{a(),z||(s=q(m,p,f))},{immediate:!0,flush:"post"}),D(a),()=>{const z=n.is;return U(z,{ref:m,class:"cdk-resize-observer"},e)}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
