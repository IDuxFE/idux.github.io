import{c as Te,d as Ee,n as Fe,k as $e,ɵ as le,l as Be,g as oe,u as re}from"./index-c13f052e.js";import{bb as O,c as x,bk as Re,x as N,bg as Oe,v as Y,a7 as we,aO as De,aX as Ue,aY as ze,bU as te,a_ as He,R as z,be as L,d as _,i as Q,q as j,aQ as ue,f as C,aW as se,af as U,bE as ce,as as H,at as ie,aK as de,aw as pe,a5 as fe,bu as ve,an as me}from"./index-639d4621.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Xe=_({name:"IxTimePicker",inheritAttrs:!1,props:Qe,setup(e,{attrs:n,expose:a,slots:t}){const l=H("common"),{globalHashId:u,hashId:i,registerToken:d}=ie("timePicker");d(oe);const p=x(()=>`${l.prefixCls}-time-picker`),o=H("locale"),c=H("timePicker"),b=re(),v=j(),{elementRef:I,focus:f,blur:m}=de(),h=x(()=>{var w;return(w=e.format)!=null?w:c.format}),{overlayOpened:s,setOverlayOpened:r}=Ie(e,f),g=Ce(e,c,b,h),{accessor:V,focused:S,handleFocus:T,handleBlur:B,handleChange:y}=g,P=X(b,h,y,pe(V,"value")),A=ye(e,c),k=_e(s,r),E={props:e,slots:t,dateConfig:b,common:l,locale:o,config:c,mergedPrefixCls:p,formatRef:h,handleKeyDown:k,inputRef:I,inputEnableStatus:A,overlayOpened:s,setOverlayOpened:r,controlContext:P,...g,handleFocus:T,handleBlur:B};fe(Z,E);const F=xe(E);a({focus:f,blur:m}),N(s,w=>{var $;w?setTimeout(()=>{var R;(R=I.value)==null||R.focus()}):(P.init(!0),S.value&&(($=v.value)==null||$.focus()))});const M=()=>C(Le,U({ref:v},n),null),q=()=>C(Ge,null,null),G=x(()=>me([`${p.value}-overlay`,u.value,i.value,e.overlayClassName]));return()=>C(ve,U(F.value,{class:`${p.value} ${u.value} ${i.value}`,overlayClassName:G.value},n),{default:M,overlay:q,suffix:t.suffix,clearIcon:t.clearIcon})}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
