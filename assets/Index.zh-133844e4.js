import{I as D,a as y}from"./index-38e45dfd.js";import{_ as S,I as $}from"./GlobalCodeBox-f139d73b.js";import{l as C,r as d,m as V,w as v,X as T,ah as r,ai as m,al as n,p as a,aj as l,an as s,ao as w,F,x as L,as as h,ar as b,am as B,az as _,ay as N,ak as q,S as A,U as M}from"./vendor-1c4f0380.js";import{u as R,c as U,_ as f,a as H}from"./index-8abf4cd4.js";const z={class:"example-focus-monitor"},Q={class:"example-focus-monitor"},j=C({__name:"FocusMonitor",setup(p){const e=d(),t=d(),o=d(null),k=d(null),u=R();return V(()=>{setInterval(()=>{o.value?u.blurVia(e.value):u.focusVia(e.value,"program")},3e3),v(u.monitor(e),({origin:c,event:i})=>{o.value=c,console.log(c,i)}),v(u.monitor(t,!0),({origin:c,event:i})=>{k.value=c,console.log(c,i)})}),T(()=>{u.stopMonitoring(e),u.stopMonitoring(t)}),(c,i)=>{const g=U;return r(),m(F,null,[n("div",z,[a(g,{ref_key:"element",ref:e,ghost:""},{default:l(()=>[s("Focus Monitored Element ("+w(o.value)+")",1)]),_:1},512)]),n("div",Q,[n("div",{ref_key:"subtree",ref:t},[n("p",null,"Focus Monitored Subtree ("+w(k.value)+")",1),a(g,{ghost:""},{default:l(()=>[s("Child Button 1")]),_:1}),a(g,{ghost:""},{default:l(()=>[s("Child Button 2")]),_:1})],512)])],64)}}});const G=f(j,[["__scopeId","data-v-0a69cab8"]]),P=C({name:"FocusMonitor",components:{"raw-demo":G},setup(){const{lang:p}=L(H);return{lang:p}}}),X=n("p",null,[n("code",null,"FocusMonitor"),s(" 可以用来监听元素焦点状态的变化。")],-1),Y=n("p",null,"你可以尝试使用鼠标或者键盘来获取按钮的焦点。",-1),J=n("p",null,[n("code",null,"FocusMonitor"),s(" can be used to listen for changes in the focus state of an element.")],-1),K=n("p",null,"You can try using the mouse or keyboard to get the focus of the button.",-1),W=n("div",null,[n("pre",{class:"language-html"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
