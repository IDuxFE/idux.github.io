import{c as Te,d as Ee,n as Fe,j as $e,ɵ as le,k as Be,g as oe,u as re}from"./index-468f4f15.js";import{bb as O,c as x,bk as Re,x as N,bg as Oe,v as Y,a7 as we,aO as De,aX as Ue,aY as ze,bW as te,a_ as He,R as z,be as G,d as j,i as L,q as _,aQ as ue,f as C,aW as se,af as U,bE as ce,as as H,at as ie,aK as de,aw as pe,a5 as fe,bu as ve,an as me}from"./index-200961bb.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const qe=j({setup(){const e=L(Z),{slots:n,props:a,locale:t,formatRef:l,dateConfig:u,inputRef:i,inputEnableStatus:d,mergedPrefixCls:p,overlayOpened:o,handleClear:c,handleKeyDown:b,controlContext:{inputValue:v,panelValue:I,inputFocused:f,handleInput:m,handleInputFocus:h,handleInputBlur:s,handlePanelChange:r}}=e,g=_(),V=()=>{var P;d.value.enableInternalInput&&(i.value=(P=g.value)==null?void 0:P.getInputElement())};Y(V),ue(V);const S=Pe(e),T=ke(a,l),{activeValue:B,setActiveValue:y}=Me(a,u,l,I);return()=>{var F;const P=`${p.value}-overlay`,A=`${p.value}-board`,k={...T.value,activeValue:B.value,visible:o.value,value:I.value,onChange:r,"onUpdate:activeValue":y},E=[C("div",{class:`${P}-body ${A}`},[d.value.enableInternalInput&&C(se,U({ref:g,class:`${A}-input`},S.value,{clearVisible:!!v.value,value:v.value,readonly:a.readonly,focused:f.value,placeholder:(F=a.placeholder)!=null?F:t.timePicker.placeholder,onInput:m,onClear:c,onFocus:h,onBlur:s,onKeydown:b}),n),C(le,U(k,{class:`${A}-panel`,tabindex:-1}),null)]),C(ce,{class:`${P}-footer`,footer:a.footer},n)];return a.overlayRender?a.overlayRender(E):C("div",null,[E])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Ge=j({inheritAttrs:!1,setup(e,{expose:n}){const a=L(Z),{accessor:t,props:l,locale:u,mergedPrefixCls:i,formatRef:d,inputRef:p,inputEnableStatus:o,controlContext:{inputValue:c,handleInput:b}}=a,v=_(),I=x(()=>{var s;return(s=l.placeholder)!=null?s:u.timePicker.placeholder}),f=x(()=>Math.max(10,d.value.length)+2),m=s=>{b(s),z(l.onInput,s)};return n({focus:()=>{var s;(s=(o.value.enableExternalInput?p:v).value)==null||s.focus()}}),()=>C("input",{ref:o.value.enableExternalInput?p:v,class:`${i.value}-input`,autocomplete:"off",disabled:t.disabled,placeholder:I.value,readonly:l.readonly||!o.value.enableExternalInput,size:f.value,value:c.value,onInput:m},null)}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Ve={...Be,open:{type:Boolean,default:void 0},control:{type:[String,Number,Object,Array],default:void 0},allowInput:{type:[Boolean,String],default:void 0},autofocus:{type:Boolean,default:void 0},borderless:{type:Boolean,default:void 0},clearable:{type:Boolean,default:void 0},clearIcon:String,clearText:String,disabled:{type:Boolean,default:!1},format:String,overlayClassName:String,overlayContainer:{type:[String,HTMLElement,Function],default:void 0},overlayTabindex:{type:Number,default:void 0},overlayRender:Function,readonly:{type:Boolean,default:!1},size:String,status:String,suffix:String,"onUpdate:open":[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onBlur:[Function,Array]},Le={...Ve,value:[String,Date,Number],defaultOpenValue:[String,Date,Number],footer:{type:[Boolean,Array,Object],default:!1},placeholder:String,"onUpdate:value":[Function,Array],onChange:[Function,Array],onInput:[Function,Array]},Qe={...Ve,value:Array,defaultOpenValue:Array,footer:{type:[Boolean,Array,Object],default:!0},placeholder:Array,separator:[String,Object],"onUpdate:value":[Function,Array],onChange:[Function,Array],onInput:[Function,Array]};/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Xe=j({name:"IxTimePicker",inheritAttrs:!1,props:Le,setup(e,{attrs:n,expose:a,slots:t}){const l=H("common"),{globalHashId:u,hashId:i,registerToken:d}=ie("timePicker");d(oe);const p=x(()=>`${l.prefixCls}-time-picker`),o=H("locale"),c=H("timePicker"),b=re(),v=_(),{elementRef:I,focus:f,blur:m}=de(),h=x(()=>{var w;return(w=e.format)!=null?w:c.format}),{overlayOpened:s,setOverlayOpened:r}=Ie(e,f),g=Ce(e,c,b,h),{accessor:V,focused:S,handleFocus:T,handleBlur:B,handleChange:y}=g,P=X(b,h,y,pe(V,"value")),A=ye(e,c),k=je(s,r),E={props:e,slots:t,dateConfig:b,common:l,locale:o,config:c,mergedPrefixCls:p,formatRef:h,handleKeyDown:k,inputRef:I,inputEnableStatus:A,overlayOpened:s,setOverlayOpened:r,controlContext:P,...g,handleFocus:T,handleBlur:B};fe(Z,E);const F=xe(E);a({focus:f,blur:m}),N(s,w=>{var $;w?setTimeout(()=>{var R;(R=I.value)==null||R.focus()}):(P.init(!0),S.value&&(($=v.value)==null||$.focus()))});const M=()=>C(Ge,U({ref:v},n),null),W=()=>C(qe,null,null),q=x(()=>me([`${p.value}-overlay`,u.value,i.value,e.overlayClassName]));return()=>C(ve,U(F.value,{class:`${p.value} ${u.value} ${i.value}`,overlayClassName:q.value},n),{default:M,overlay:W,suffix:t.suffix,clearIcon:t.clearIcon})}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */function Ye(e,n,a){const[t,l]=O(G(a.value).map(f=>K(e,f,n.value))),[u,i]=O(!1),d=f=>{l(Je(e,f,n.value)),i(!0)};N([a,n],([f])=>{d(f)});const p=x(()=>G(t.value)),o=x(()=>p.value[0]),c=x(()=>p.value[1]),b=X(e,n,f=>{d([f,c.value])},o),v=X(e,n,f=>{d([o.value,f])},c);return{buffer:t,bufferUpdated:u,fromControl:b,toControl:v,init:(f=!1)=>{d(a.value),i(!1),b.init(f),v.init(f)}}}function Je(e,n,a){return G(n).map(t=>K(e,t,a))}/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Ze=j({setup(){const e=L(ee),{props:n,slots:a,dateConfig:t,locale:l,mergedPrefixCls:u,formatRef:i,inputRef:d,inputEnableStatus:p,overlayOpened:o,handleChange:c,handleKeyDown:b,renderSeparator:v,setOverlayOpened:I,rangeControlContext:{buffer:f,fromControl:m,toControl:h}}=e,s=_(),r=()=>{var k;p.value.enableInternalInput&&(d.value=(k=s.value)==null?void 0:k.getInputElement())};Y(r),ue(r);const g=Pe(e),V=ke(n,i),{fromActiveValue:S,toActiveValue:T,setFromActiveValue:B,setToActiveValue:y}=We(n,t,i,x(()=>[m.panelValue.value,h.panelValue.value])),P=()=>{c(f.value),I(!1)};function A(k){var ne,ae;const{inputValue:E,inputFocused:F,panelValue:M,handleInput:W,handleInputClear:q,handleInputFocus:w,handleInputBlur:$,handlePanelChange:R}=k?m:h,D=k?0:1,Se=(ae=(ne=n.placeholder)==null?void 0:ne[D])!=null?ae:l.timeRangePicker.placeholder[D],Q=`${u.value}-board`,Ae={...V.value,activeValue:k?S.value:T.value,visible:o.value,value:M.value,onChange:R,"onUpdate:activeValue":k?B:y};return C("div",{class:Q},[p.value.enableInternalInput&&C(se,U({ref:k?s:void 0,class:`${Q}-input`},g.value,{clearVisible:!!E.value,value:E.value,readonly:n.readonly,focused:F.value,placeholder:Se,onInput:W,onClear:q,onFocus:w,onBlur:$,onKeydown:b}),a),C(le,U(Ae,{class:`${Q}-panel`,tabindex:-1}),null)])}return()=>{const k=`${u.value}-overlay`,E={[`${k}-separator`]:!0,[`${k}-separator-line`]:!p.value.enableInternalInput},F=[C("div",{class:`${k}-body`},[A(!0),C("div",{class:E},[p.value.enableInternalInput&&v()]),A(!1)]),C(ce,{class:`${k}-footer`,footer:n.footer,okText:l.timeRangePicker.okText,okButton:{size:"xs",mode:"primary"},cancelVisible:!1,ok:P},a)];return n.overlayRender?n.overlayRender(F):C("div",null,[F])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const en=j({inheritAttrs:!1,setup(e,{expose:n}){const a=L(ee),{accessor:t,props:l,locale:u,mergedPrefixCls:i,inputRef:d,inputEnableStatus:p,renderSeparator:o,rangeControlContext:{fromControl:c,toControl:b}}=a,v=_(),I=x(()=>{var r,g,V,S;return[(g=(r=l.placeholder)==null?void 0:r[0])!=null?g:u.timeRangePicker.placeholder[0],(S=(V=l.placeholder)==null?void 0:V[1])!=null?S:u.timeRangePicker.placeholder[1]]});n({focus:()=>{var r;(r=(p.value.enableExternalInput?d:v).value)==null||r.focus()}});const m=r=>{c.handleInput(r),z(l.onInput,!0,r)},h=r=>{b.handleInput(r),z(l.onInput,!1,r)};function s(r,g){const{inputValue:V}=g?c:b,S=I.value[g?0:1],T=g?m:h;return C("input",{ref:g?p.value.enableExternalInput?d:v:void 0,class:`${r}-input-inner`,autocomplete:"off",disabled:t.disabled,value:V.value,placeholder:S,readonly:l.readonly||!p.value.enableExternalInput,onInput:T},null)}return()=>{const r=i.value;return C("span",{class:`${r}-input`},[s(r,!0),C("span",{class:`${r}-input-separator`},[o()]),s(r,!1)])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const nn=j({name:"IxTimeRangePicker",inheritAttrs:!1,props:Qe,setup(e,{attrs:n,expose:a,slots:t}){const l=H("common"),{globalHashId:u,hashId:i,registerToken:d}=ie("timePicker");d(oe);const p=x(()=>`${l.prefixCls}-time-range-picker`),o=H("locale"),c=H("timePicker"),b=re(),v=_(),{elementRef:I,focus:f,blur:m}=de(),h=x(()=>{var $;return($=e.format)!=null?$:c.format}),{overlayOpened:s,setOverlayOpened:r}=Ie(e,f),g=Ce(e,c,b,h),{accessor:V,focused:S,handleFocus:T,handleBlur:B,handleChange:y}=g,P=Ye(b,h,pe(V,"value")),A=ye(e,c),k=_e(P,s,r,y),F={props:e,slots:t,dateConfig:b,common:l,locale:o,config:c,mergedPrefixCls:p,formatRef:h,handleKeyDown:k,inputRef:I,inputEnableStatus:A,overlayOpened:s,setOverlayOpened:r,renderSeparator:()=>{var $,R,D;return(D=(R=($=t.separator)==null?void 0:$.call(t))!=null?R:e.separator)!=null?D:o.timeRangePicker.separator},rangeControlContext:P,...g,handleFocus:T,handleBlur:B},M=xe(F);fe(ee,F),a({focus:f,blur:m}),N(s,$=>{var R;$?setTimeout(()=>{var D;(D=I.value)==null||D.focus()}):(P.init(!0),S.value&&((R=v.value)==null||R.focus()))});const W=()=>C(en,U({ref:v},n),null),q=()=>C(Ze,null,null),w=x(()=>me([`${p.value}-overlay`,u.value,i.value,e.overlayClassName]));return()=>C(ve,U(M.value,{class:`${p.value} ${u.value} ${i.value}`,overlayClassName:w.value},n),{default:W,overlay:q,suffix:t.suffix,clearIcon:t.clearIcon})}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
