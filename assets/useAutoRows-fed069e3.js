import{a2 as k,a6 as D}from"./index-b887bcb8.js";import{a4 as P,w as m,e as H,M as $,x,aj as G,au as I,G as U,j as V,L as _}from"./vendor-4521613a.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const S=e=>V(e)&&(_(e.minRows)||_(e.maxRows));function J(e,n){let r,i,o,a=!1,u,c;const g=H(()=>S(n.value)||I(n.value)&&!!n.value),s=H(()=>S(n.value)?n.value.minRows:void 0),b=H(()=>S(n.value)?n.value.maxRows:void 0),d=X(e),h=H(()=>e.value?E(e.value):{paddingSize:0,borderSize:0,boxSizing:""});function F(){return z(e.value,l=>(l.value=e.value.value,l.scrollHeight,y(l.scrollHeight,h.value)))}function C(){return!e.value||!e.value.placeholder?0:(c||z(e.value,t=>{t.style.height="",t.value=t.placeholder,t.scrollHeight,c=y(t.scrollHeight,h.value)}),c)}function f(l=!1){if(!g.value||!d.value)return;const t=e.value,v=t.value;if(!l&&s.value===i&&v===r)return;t.style.lineHeight=`${d.value}px`;const L=Math.max(F(),C());t.style.height=`${L}px`,u=u??t.style.overflow,t.style.overflow="hidden",U(()=>D(()=>{O(t),t.style.overflow=u??"",u=void 0})),r=v,i=s.value}function M(){if(!e.value)return;const l=s.value&&d.value?s.value*d.value:null,t=l?`${B(l,h.value)}px`:"";e.value.style.maxHeight=t}function N(){if(!e.value)return;const l=b.value&&d.value?b.value*d.value:null,t=l?`${B(l,h.value)}px`:"";e.value.style.maxHeight=t}function O(l){const{selectionStart:t,selectionEnd:v}=l;a&&document.activeElement===l&&l.setSelectionRange(t,v)}function j(){o!==void 0&&e.value&&(e.value.style.height=o)}let p;const A=$(()=>{c=void 0,f(!0)},16);return x(()=>{const l=[m(e,()=>{e.value&&(o=e.value.style.height)},{immediate:!0}),m(n,()=>{g.value?f(!0):j()},{immediate:!0}),m(s,()=>{M()},{immediate:!0}),m(b,()=>{N()},{immediate:!0})],t=k(e,A);p=()=>{l.forEach(v=>v()),t()},a=!0}),G(()=>{p==null||p(),a=!1}),{resizeToFitContent:f,lineHeight:d,boxSizingData:h}}function y(e,n){const{borderSize:r,paddingSize:i,boxSizing:o}=n;return o==="border-box"?e+r:e-i}function B(e,n){const{borderSize:r,paddingSize:i,boxSizing:o}=n;return o==="border-box"?e+r+i:e+i}export{z as m,J as u};
