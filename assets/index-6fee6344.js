import{d as x,as as g,at as h,c as d,b8 as H,an as L,f as y,bg as A,a4 as B,b_ as b,K as D,x as F,H as _,af as j,i as E,bk as N,$ as O,j as w}from"./index-2f15ff81.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const Q=x({name:"IxLayoutSider",props:G,setup(r,{slots:e}){const f=g("common"),{globalHashId:o,hashId:s}=h("layout"),l=d(()=>`${f.prefixCls}-layout-sider`),[u,t]=A(r,"collapsed",!1);B(P,{mergedPrefixCls:l,collapsed:u,setCollapsed:t});const m=d(()=>{const{breakpoint:i}=r;return i?b.indexOf(i):-1}),n=d(()=>m.value>-1),a=D();let c;F(n,i=>{c==null||c(),i&&(c=_(()=>{const v=b.findIndex(I=>a[I]);t(v<=m.value,"breakpoint")}))},{immediate:!0});let p;const C=i=>{const{pointerDelay:v}=r,[I,$]=Array.isArray(v)?v:[v,v];p&&clearTimeout(p),p=setTimeout(()=>{t(i,"pointer"),p=void 0},i?I:$)},k=d(()=>{if(r.pointer)return{onPointerenter:()=>C(!1),onPointerleave:()=>C(!0)}}),T=d(()=>{const i=l.value;return L({[o.value]:!!o.value,[s.value]:!!s.value,[i]:!0,[`${i}-collapsed`]:u.value})});return()=>{var i;return y("aside",j({class:T.value},k.value),[(i=e.default)==null?void 0:i.call(e)])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const X=x({name:"IxLayoutSiderTrigger",props:R,setup(r,{slots:e}){const{mergedPrefixCls:f,collapsed:o,setCollapsed:s}=E(P),{globalHashId:l,hashId:u}=h("layout"),t=d(()=>{const{icon:a}=r,[c="menu-fold",p="menu-unfold"]=Array.isArray(a)?a:[a,a];return o.value?c:p}),m=d(()=>{const a=`${f.value}-trigger`;return{[l.value]:!!l.value,[u.value]:!!u.value,[a]:!0,[`${a}-collapsed`]:o.value}}),n=()=>{s(!o.value,"trigger")};return()=>{var c;let a;if(e.icon)a=e.icon({collapsed:o.value});else{const p=t.value;a=N(p)?y(O,{name:p},null):p}return y("div",{class:m.value},[y("span",null,[(c=e.default)==null?void 0:c.call(e)]),y(w,{mode:"text",onClick:n},{icon:()=>a})])}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const ee=Y,ae=q,oe=J,te=M,ne=Q,re=X;export{te as I,ne as a,ae as b,oe as c,ee as d,re as e};
