import{v as A,i as I,f as v,z as P,y as C,b as R,t as T,p as j,w as $,N as G,A as D}from"./vendor-50817465.js";import{aj as B,m as M,o as H,D as L}from"./index-8bc6cdd3.js";/**
 * @license
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */const te=A({name:"CdkResizeObserver",props:ee,setup(n,{slots:e}){const m=R(),p=z=>M(n.onResize,z);let s;const a=()=>{s&&(s(),s=void 0)};return $([()=>n.disabled,()=>n.options],([z,f])=>{a(),z||(s=L(m,p,f))},{immediate:!0,flush:"post"}),G(a),()=>{const z=n.is;return D(z,{ref:m,class:"cdk-resize-observer"},e)}}});/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
